...
//var sqlConnectionConfiguration = new SqlConnectionConfiguration(builder.Configuration.GetConnectionString("CadastroDB")) ; // String de conexão
...
builder.Services.AddScoped<IDapperDal, DapperDAL>(); // Registro do Serviço da camada acesso dados
